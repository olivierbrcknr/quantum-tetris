...
if (device.getButton("A").getValue()==8) {
  println("A");
} else if (device.getButton("B").getValue()==8){
  println("B");
} else if (device.getButton("Start").getValue()==8){
  println("Start");
} else if (device.getButton("Select").getValue()==8){
  println("Select");
}
//println (device.getButton("Select").getValue());
//println(DLR);
//println(DUD);
}
